...
# NOTE: The following functions like `is_greeting`, `is_formatting_request`, etc.
# are the older, separate functions as provided in your original `query_analysis.py`.
# The `extract_all_metadata` function (used in newer `fastapi_app.py` versions) is not present here.
